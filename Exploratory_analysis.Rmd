...
vis_all <- vis_all %>% 
  mutate(
    ...
    across(c(education_v7) , function(x)
      x %>% factor(
        levels = c(1, 2, 3, 4, 5),
        labels = c( "Completed higher education", "Incomplete higher education", "Secondary specialized education", "Secondary education", "Incomplete secondary education")
      )),
    across(c(education_v8) , function(x)
      x %>% factor(
        levels = c(1, 2, 3, 4, 5, 6),
        labels = c( "Academic degree", "Completed higher education", "Incomplete higher education", "Secondary specialized education", "Secondary education", "Incomplete secondary education")
      )),
    ...
    across(c(stroke_v7, braininjury_v7, diabetes_v7, renald_v7, pulmonaryd_v7, gastrod_v7, allergy_v7, inflammation_v7, fcad_v7, fah_v7, fstroke_v7, fdiabetes_v7,  mcad_v7, mah_v7, mstroke_v7, mdiabetes_v7) , function(x)
      x %>% factor(
        levels = c(1, 2, 9),
        labels = c( "Yes", "No", "Don`t know")
      )),
    across(c(stroke_v8, braininjury_v8, diabetes_v8, renald_v8, pulmonaryd_v8, gastrod_v8, allergy_v8, inflammation_v8, blood_v8, fcad_v8, fah_v8, fstroke_v8, fdiabetes_v8,  mcad_v8, mah_v8, mstroke_v8, mdiabetes_v8) , function(x)
      x %>% factor(
        levels = c(1, 2, 3),
        labels = c( "Yes", "No", "Don`t know")
      )),
    ...
    across(c(fliving_v7, fliving_v8, mliving_v7, mliving_v8) , function(x)
     ...
     across(c(fcause_v7, fcause_v8, mcause_v7, mcause_v8) , function(x)
      x %>% factor(
        levels = c(1, 2,3 ,4, 5, 6),
        labels = c( "Heart attack",  "Stroke",  "Cancer",  "Chronic diseases",  "Accident",  "Unknown")
      ))
